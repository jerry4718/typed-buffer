...
export class StringParser extends AdvancedParser<string> {
    ...
    read(ctx: ParserContext<unknown>, byteOffset: number, option?: ParserOptionComposable): ValuePair<string> {
    ...
    write(parentContext: ParserContext<unknown>, byteOffset: number, value: string, option?: ParserOptionComposable): ValuePair<string> {
